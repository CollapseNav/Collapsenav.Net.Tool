...
public class CrudRepControllerTest
{
    ...
    {
        using var RepController = GetService<ICrudRepController<int, TestEntity, TestEntityCreate, TestEntityGet>>();
    ...
    public async Task AddTest()
    {
        ...
        using var queryController = GetService<ICrudRepController<int, TestEntity, TestEntityCreate, TestEntityGet>>();
    ...
    {
        var queryController = GetService<ICrudRepController<int, TestEntity, TestEntityCreate, TestEntityGet>>();
        using var RepController = GetService<ICrudRepController<int, TestEntity, TestEntityCreate, TestEntityGet>>();
        ...
        RepController.Dispose();
        queryController = GetService<ICrudRepController<int, TestEntity, TestEntityCreate, TestEntityGet>>();
